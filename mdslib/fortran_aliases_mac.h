...
EXPORT int mdsclose_(char *tree, int *shot) { return MdsClose(tree, shot); }
EXPORT void mdsdisconnect_() { MdsDisconnect(); }
EXPORT void mdsdisconnectr_(int *connection) { MdsDisconnectR(connection); }
EXPORT int mdsopen_(char *tree, int *shot) { return MdsOpen(tree, shot); }
EXPORT int mdsopenr_(int *connection, char *tree, int *shot) { return MdsOpenR(connection, tree, shot); }
EXPORT int mdssetdefault_(char *node) { return MdsSetDefault(node); }
EXPORT int mdssetdefaultr_(int *connection, char *node) { return MdsSetDefaultR(connection, node); }
EXPORT int mdssetsocket_(int *newsocket) { return MdsSetSocket(newsocket); }
EXPORT int
mdsput_(char *node, char *expression, int *a00, int *a01, int *a02, int *a03,
...
EXPORT int
mdsputr_(int *connection, char *node, char *expression, int *a00, int *a01, int *a02, int *a03,
        int *a04, int *a05, int *a06, int *a07, int *a08, int *a09, int *a10,
        int *a11, int *a12, int *a13, int *a14, int *a15, int *a16, int *a17,
        int *a18, int *a19, int *a20, int *a21, int *a22, int *a23, int *a24,
        int *a25, int *a26, int *a27, int *a28, int *a29, int *a30, int *a31,
...
EXPORT int
mdsvalue_(char *expression, int *a00, int *a01, int *a02, int *a03, int *a04,
...
EXPORT int
mdsvaluer_(int *connection, char *expression, int *a00, int *a01, int *a02, int *a03, int *a04,
          int *a05, int *a06, int *a07, int *a08, int *a09, int *a10, int *a11,
          int *a12, int *a13, int *a14, int *a15, int *a16, int *a17, int *a18,
          int *a19, int *a20, int *a21, int *a22, int *a23, int *a24, int *a25,
          int *a26, int *a27, int *a28, int *a29, int *a30, int *a31, int *a32,
...
EXPORT int
mdsput2_(char *node, char *expression, int *a00, int *a01, int *a02, int *a03,
         int *a04, int *a05, int *a06, int *a07, int *a08, int *a09, int *a10,
         int *a11, int *a12, int *a13, int *a14, int *a15, int *a16, int *a17,
         int *a18, int *a19, int *a20, int *a21, int *a22, int *a23, int *a24,
         int *a25, int *a26, int *a27, int *a28, int *a29, int *a30, int *a31,
...
EXPORT int
mdsput2r_(int *connection, char *node, char *expression, int *a00, int *a01, int *a02, int *a03,
         int *a04, int *a05, int *a06, int *a07, int *a08, int *a09, int *a10,
         int *a11, int *a12, int *a13, int *a14, int *a15, int *a16, int *a17,
         int *a18, int *a19, int *a20, int *a21, int *a22, int *a23, int *a24,
         int *a25, int *a26, int *a27, int *a28, int *a29, int *a30, int *a31,
...
EXPORT int
mdsvalue2_(char *expression, int *a00, int *a01, int *a02, int *a03, int *a04,
           int *a05, int *a06, int *a07, int *a08, int *a09, int *a10, int *a11,
           int *a12, int *a13, int *a14, int *a15, int *a16, int *a17, int *a18,
           int *a19, int *a20, int *a21, int *a22, int *a23, int *a24, int *a25,
           int *a26, int *a27, int *a28, int *a29, int *a30, int *a31, int *a32,
...
EXPORT int
mdsvalue2r_(int *connection, char *expression, int *a00, int *a01, int *a02, int *a03, int *a04,
           int *a05, int *a06, int *a07, int *a08, int *a09, int *a10, int *a11,
           int *a12, int *a13, int *a14, int *a15, int *a16, int *a17, int *a18,
           int *a19, int *a20, int *a21, int *a22, int *a23, int *a24, int *a25,
           int *a26, int *a27, int *a28, int *a29, int *a30, int *a31, int *a32,
